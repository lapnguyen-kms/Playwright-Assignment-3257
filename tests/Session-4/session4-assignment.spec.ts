...
test('TC004 - Verify Frames', { tag: '@regression' },async ({ page }) => {
    ...
    await frameLocator.getByPlaceholder('Search...').fill('Playwright');
...
test('TC005 - Verify Upload file', { tag: '@regression' }, async ({ page }) => {
    ...
    await page.locator('#file-upload').setInputFiles('/Users/lapnguyen/Documents/TS/tests/Session-4/Screenshot 2024-03-07 at 11.41.53 AM.png');
